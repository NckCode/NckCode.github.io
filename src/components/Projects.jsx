...
const projects = [
  ...
  },
  {
    ...
    image: "/src/assets/Pd1.jpg",
    link: "https://github.com/NckCode/plastic-detection-yolo",
  },
  {
    title: "COVID Tracker",
    description: "Real-time COVID-19 statistics dashboard with interactive visualizations.",
    tags: ["React",  "API Integration", "Data Visualization"],
    image: "/src/assets/Covid-snap1.png",
...
const Projects = () => {
    ...
    const ctx = gsap.context(() => {
      ...
      projectRefs.current.forEach((project, index) => {
        tl.from(project, {
          ...
          duration: 1,
          ease: "power3.out",
        }, index * 0.3); // Stagger each project
      });
  ...
  return (
    <section ref={sectionRef} className="min-h-screen bg-black px-6 md:px-10 py-32 flex flex-col items-center justify-center">
              ...
              >
                <div className="image-wrapper aspect-video">
                  ...
                  <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                    <span className="text-white text-lg font-light">View Project</span>
                  </div>
                </div>
